package it.iccs.simeal.sdi.domande.adapter.outbound.persistence;

import it.iccs.simeal.sdi.domande.adapter.outbound.persistence.mapper.DomandaEntityMapper;
import it.iccs.simeal.sdi.domande.adapter.outbound.persistence.repository.DomandaRepository;
import it.iccs.simeal.sdi.domande.adapter.outbound.persistence.repository.entity.DomandaEntity;
import it.iccs.simeal.sdi.domande.adapter.outbound.persistence.repository.specification.DomandaSpecification;
