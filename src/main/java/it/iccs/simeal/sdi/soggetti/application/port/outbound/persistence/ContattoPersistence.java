...
public interface ContattoPersistence {
	
	ContattoModel save(ContattoModel model);
	
	List<ContattoModel> findByIds(List<UUID> ids);

	Page<ContattoModel> search(ContattoCriteria criteria, Pageable pageRequest);
