...
public interface DocumentoPersistence {
	...
	DocumentoModel save(DocumentoModel model);
	
	List<DocumentoModel> findByIds(List<UUID> ids);

	Page<DocumentoModel> search(DocumentoCriteria criteria, Pageable pageRequest);
